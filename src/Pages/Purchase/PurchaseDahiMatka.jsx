...
const PurchaseDahiMatka = () => {
  ...
  useEffect(() => {
    if (fetchedName == null || fetchedName.length == 0) {
      ...
      axios
        .get(
          `https://purchase-dispatch-excel.vercel.app/api/v1/purchase/dahi-matka`,
          {
            headers: {
              Authorization: `Bearer ${localStorage.getItem("token")}`,
            },
  ...
  return (
    <>
      <div className="mobile-screen sm:rounded-2xl flex flex-col bg-black text-white">
        <Navbar name={"Purchase / Dahi Matka"} />
        <div
            ...
            >
              ...
              <div className="flex flex-col gap-2">
                ...
                <input
                  ...
                  placeholder="Enter Dahi Matka Quantity ..."
                  className="w-full p-3 rounded-md bg-[#121212] text-white outline-none cursor-pointer"
                />
              </div>
              <button
...
export default PurchaseDahiMatka;

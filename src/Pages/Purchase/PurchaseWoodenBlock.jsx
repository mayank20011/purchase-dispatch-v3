...
const PurchaseWoodenBlock = () => {
  ...
  function submitData() {
    ...
    axios
      .post(
        "https://purchase-dispatch-excel.vercel.app/api/v1/purchase/wooden-block/push-data-to-sheet",
  ...
  useEffect(() => {
    if (fetchedName == null || fetchedName.length == 0) {
      ...
      axios
        .get(
          `https://purchase-dispatch-excel.vercel.app/api/v1/purchase/wooden-block`,
          {
            headers: {
              Authorization: `Bearer ${localStorage.getItem("token")}`,
            },
          ...
          {fetchLoading ? (
            ...
            >
              ...
              <div className="flex flex-col gap-2">
                ...
                >
                  Enter Wooden Quantity in (Tones)
                </label>
                <input
                  value={quantity}
                  type="number"
                  ...
                  placeholder="Enter Wood Quantiy ..."
                  className="w-full p-3 rounded-md bg-[#121212] text-white outline-none cursor-pointer"
                />
              </div>
              <button
      ...
      >
        ...
        >
          ...
          >
            ...
            <div className="flex items-center gap-4 font-bold">
              <h1 className="text-blue-400">Total Wood:</h1>
              <h1 className="font-semibold ">{quantity} (tonne)</h1>
            </div>
          </div>
          {/* for button */}
